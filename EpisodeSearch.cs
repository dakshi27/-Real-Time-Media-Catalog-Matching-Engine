...

{
...

    {
        ...
        [FunctionName("EpisodeSearch")]

        public static async Task<IActionResult> Run(

            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v1/Episodes/")] HttpRequest req,
...

        {
            ...
            var result = await dbManager.FetchEpisodeResults(subcategory, searchKey);
