...

{
...

    {
        ...
        [FunctionName("MovieSearch")]

        public static async Task<IActionResult> Run(

            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v1/Movies/")] HttpRequest req,
...

        {
            ...
            var result = await dbManager.FetchMovieResults(subcategory, searchKey);
